        ...
        <div class="d-flex flex-column flex-column-fluid">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">    
                            ...
                            <li class="breadcrumb-item text-muted">Edit Page</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                <div id="kt_app_content_container" class="app-container container-xxl">
                    <form 
                        action="{{route('admin.cms-pages.update', $data->id)}}"
                        method="POST"  
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <option value="1" @if($data->is_active =='active') selected @endif >Active</option>
                                    <option value="0" @if($data->is_active =='Inactive') selected @endif>Inactive</option>
                                </select>
                                ...
                                <div class="card-body pt-0">
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="title" class="form-control mb-2"
                                            placeholder="Page name" value="{{$data->title}}"  />
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" name="slug" class="form-control mb-2"
                                            placeholder="Slug name e.g. privacy-policy" value="{{$data->slug}}"  />
                                ...
                                <div class="card-body pt-0">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" class="form-control mb-2" name="meta_title"
                                            placeholder="Meta tag name" value="{{$data->meta_title}}"/>
                                    ...
                                    <div>
                                        ...
                                        <input id="kt_ecommerce_add_category_meta_keywords"
                                            name="meta_keywords" class="form-control mb-2" value="{{$data->meta_keywords}}"/>
